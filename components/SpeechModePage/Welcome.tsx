  ...
  return (
    <div className="p-8">
      <h1 className="text-3xl text-center font-bold mb-8">
        Welcome to the{" "}
        <span className="text-blue-600">Speak for 2 min mode</span>
      </h1>
      ...
      <div className="grid grid-cols-2 gap-8 mt-8">
        <div>
          ...
          <ol className="list-decimal list-inside text-gray-800">
            ...
            <li>
              The moment you press that button you’ll be presented with a topic
              to review for 5-10 sec and a stopwatch timer.
            </li>
            <li>
              When you feel you’re ready, start recording your speech and try to
              complete it in under 2 min (recording will be automatically
